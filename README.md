...
- Home hub (Mood Log, Chat with Aura, Find Resources)  
  `![Home](Docs/home.png)`
- Mood Log (private log + publish to community)  
  `![Mood Log](Docs/mood-log.png)`
- Community feed with likes  
  `![Community](Docs/community.png)`
- AI Chat conversation  
  `![AI Chat](Docs/ai-chat.png)`
- Resources: list + nearby support + map/nav  
  `![Resources List](Docs/resources-list.png)`  
  `![Resources Nearby](Docs/resources-nearby.png)`  
  `![Resources Map](Docs/resources-map.png)`  
  `![Resources Directions](Docs/resources-directions.png)`

Replace the placeholders with real images placed in `Docs/` or another folder of your choice.
